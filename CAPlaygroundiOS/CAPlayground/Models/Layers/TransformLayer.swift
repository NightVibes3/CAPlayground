...
/// A layer used for grouping and transforming child layers.
/// Mirrors the TypeScript type: `TransformLayer`
import Foundation

struct TransformLayer: Codable, Hashable, Identifiable {
    var id: String
    var name: String
