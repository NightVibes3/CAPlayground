...
/// A basic container layer with no special rendering.
/// Mirrors the TypeScript type: `BasicLayer`
import Foundation

struct BasicLayer: Codable, Hashable, Identifiable {
    var id: String
    var name: String
    ...
    enum CodingKeys: String, CodingKey {
        case id, name, children, position, zPosition, size, opacity
        case rotation, rotationX, rotationY, backgroundColor, backgroundOpacity
        case borderColor, borderWidth, cornerRadius, visible, anchorPoint
        case geometryFlipped, masksToBounds, animations, blendMode, filters, type
    }
}
